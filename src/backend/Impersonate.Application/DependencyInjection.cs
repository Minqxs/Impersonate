...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services) => services
        ...
        .AddScoped<IFinalPullRequestOrchestrator, FinalPullRequestOrchestrator>()
        .AddScoped<IFinalRunMergeService, FinalRunMergeService>()
        .AddScoped<IFinalRunDeliveryService, FinalRunDeliveryService>()
