...
public sealed class CodeQualityCredentialSecret
{
 ...
 public CodeQualityCredentialSecret(Guid id,string payload){ConfigurationId=id;Replace(payload);}
 public void Replace(string payload){ProtectedPayload=payload;UpdatedAtUtc=DateTimeOffset.UtcNow;}
}
