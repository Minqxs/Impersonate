...
public sealed class ExecutionInvocation
{
    ...
    public int PatchAttemptCount { get; private set; }
    public int FailedPatchCount { get; private set; }
    public string? LastPatchFailureCode { get; private set; }
