...
public sealed class ProjectTests
{
    ...
    public void Create_NormalizesValues_AndDefaultsToIdle()
    {
        ...
        Assert.Equal("Impersonate", project.Name);
        Assert.Equal(ProjectStatus.Idle, project.Status);
        Assert.Equal("https://github.com/example/repo.git", project.RepositoryUrl);
    ...
    public void ChangeStatus_UpdatesStatusAndTimestamp()
    {
        ...
        project.ChangeStatus(ProjectStatus.Active, then);
